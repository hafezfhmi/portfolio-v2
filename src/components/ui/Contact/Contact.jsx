...
const Contact = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="border-b-4 border-black bg-main-darkBlue overflow-hidden"
    >
      ...
      <div className="grid md:grid-cols-2 text-lg md:text-xl xl:text-2xl 2xl:text-3xl">
        <div className="flex flex-col justify-center py-8 px-6">
          ...
          <ul className="flex gap-x-4">
            <li className="flex justify-center items-center w-16 h-16 border-2 border-black rounded-full bg-white">
              <svg
